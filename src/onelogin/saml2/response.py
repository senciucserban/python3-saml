...
class OneLogin_Saml2_Response(object):
    ...
    def check_assertion_version(self):
        ...
        if len(assertion_node) == 1 and assertion_node[0].get('Version') == '2.0':
            return True
        else:
            return False
    ...
    def get_issue_instant_response(self):
        """
        Returns the IssueInstant value of the valid Response node if any
        """
        return self.document.get('IssueInstant')
